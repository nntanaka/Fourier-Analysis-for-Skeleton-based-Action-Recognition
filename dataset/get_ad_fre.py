...
parser.add_argument('--aepath', default='../stgcn_joint_misclassified_AE.npz',
                    help='location of adversarial examples npz file')
...
if __name__ == '__main__':
    ...
    with open('./joint_perturbation_spectrum.pkl', 'wb') as f:
