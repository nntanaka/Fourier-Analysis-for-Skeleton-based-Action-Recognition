...
if __name__ == '__main__':
    ...
    for index in tqdm(range(N)):
        ...
        C, T, V, M = data_numpy.shape
        #data_numpy = filter(data_numpy, Q, spatial_pass='low', temporal_pass='low')
    ...
    with open('./input_fre/bv_spatial.pkl', 'wb') as f:
        pickle.dump(spatial_dict, f)
        
    with open('./input_fre/bv_temporal.pkl', 'wb') as f:
        pickle.dump(temporal_dict, f)
    
    with open('./input_fre/bv_spatial_temporal.pkl', 'wb') as f:
