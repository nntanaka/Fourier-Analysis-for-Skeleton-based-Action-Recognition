...
if __name__ == '__main__':
    ...
    del npz_data
    npz_data = np.load('./ntu60/frequency_noise/bonevel/low_band_4.npz')#npz_data = np.load('ntu60/cs_occluded/occluded_part/occluded_part_ind_5.npz')
    ...
    with open('./bv_filtered_low_spatial.pkl', 'wb') as f:
        pickle.dump(spatial_dict, f)
        
    with open('./bv_filtered_low_temporal.pkl', 'wb') as f:
        pickle.dump(temporal_dict, f)
    
    with open('./bv_filtered_low_spatial_temporal.pkl', 'wb') as f:
