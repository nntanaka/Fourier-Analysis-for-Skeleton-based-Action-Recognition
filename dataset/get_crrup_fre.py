...
if __name__ == '__main__':
    ...
    del npz_data
    npz_data = np.load('./ntu60/cs_occluded/jittering_ske/skeleton_jittering_std_005.npz')
    ...
    with open('./j_ske_jitter_spatial.pkl', 'wb') as f:
        pickle.dump(spatial_dict, f)
        
    with open('./j_ske_jitter__temporal.pkl', 'wb') as f:
        pickle.dump(temporal_dict, f)
    
    with open('./j_ske_jitter_spatial_temporal.pkl', 'wb') as f:
